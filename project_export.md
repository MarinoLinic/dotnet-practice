# EmployeeApi — Project Export
Exported: 2026-05-18 21:15:02

This markdown file contains the complete project structure and all source files.
To reconstruct the project, create the folder structure and copy each code block into the corresponding file.
...
# Ignore generated build output from dotnet publish
publish/
...
# Ignore local NuGet cache
**/packages/

# Ignore HTTP request files if not part of source
*.http
...
```text
@EmployeeApi_HostAddress = http://localhost:5285

GET {{EmployeeApi_HostAddress}}/weatherforecast/
...
﻿{
  ...
  "profiles": {
    ...
    "https": {
      ...
      "dotnetRunMessages": true,
      "launchBrowser": false,
      "applicationUrl": "https://localhost:7241;http://localhost:5285",
      "environmentVariables": {
        "ASPNETCORE_ENVIRONMENT": "Development"
      }
    }
